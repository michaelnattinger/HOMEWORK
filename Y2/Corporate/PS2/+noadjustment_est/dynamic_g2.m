...
if T_flag
    T = noadjustment_est.dynamic_g2_tt(T, y, x, params, steady_state, it_);
end
v2 = zeros(14,3);
v2(1,1)=2;
v2(2,1)=2;
...
v2(13,2)=7;
v2(14,2)=85;
v2(1,3)=(-(y(12)*params(1)*y(11)*getPowerDeriv(y(4),params(1)-1,2)));
v2(2,3)=(-(y(12)*params(1)*T(5)));
v2(3,3)=v2(2,3);
v2(4,3)=(-(params(1)*y(11)*T(5)));
v2(5,3)=v2(4,3);
v2(6,3)=(-(params(1)*T(1)));
v2(7,3)=v2(6,3);
