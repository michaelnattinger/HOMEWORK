...
double precision, parameter :: 				tune_K			 		= 0.99d0
double precision, parameter :: 				tune_L			 		= 0.99d0
double precision, parameter :: 				a_tol			 		= 1d-3
...
rental = cALPHA* ((K_demand)**(cALPHA - 1))*((L_demand)**(1 - cALPHA))
