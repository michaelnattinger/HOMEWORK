...
Therefore, we have a unique solution so long as $\phi > \max\left\{ \frac{-\kappa - 1}{\beta} ,  \kappa\frac{1-\frac{2}{\beta}}{1-\beta}\right\}$. Note that $\phi>0$ is sufficient to satisfy this condition.
\end{document}
