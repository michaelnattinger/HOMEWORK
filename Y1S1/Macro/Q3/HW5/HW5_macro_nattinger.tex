...
\begin{align}
 \frac{\theta\bar{C}}{\varphi\bar{A}}(y_t - a_t) + \frac{\beta}{\bar{P}}E_t[\pi_{t+1} ] &=\pi_t. \label{NKPC}
\end{align}
...
If we define $x_t = y_t - a_t$ as our output gap, and further define $\kappa =  \frac{\theta\bar{C}}{\varphi\bar{A}}$, then our NKPC becomes the following:
\begin{align*}
