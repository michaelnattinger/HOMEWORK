...
\end{align}
Equation (\ref{eqn:euler}) yields our Euler conditions. This implies that the optimal saving policy is to save a current fraction of current assets. %show via guess and verify?
...
\begin{align*}
\gamma' (k' - (1-\delta)k) &= \frac{1}{R}\beta V'(k')\\%\left( \pi'(k') + (1-\delta) \gamma'(k'' - (1-\delta)k') \right)\\
...
\end{align*}
This, in addition to our law of motion for capital, $k' = I + (1-\delta)k$, forms the law of motion for capital and investment.

If the interest rate were to rise, there would not be an initial change in the capital level as $k'$ is already exactly determined by $I,k$. Investment spending would instead adjust and would have to increase.
