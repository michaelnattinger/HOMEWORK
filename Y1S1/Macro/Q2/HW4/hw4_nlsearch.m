...
if recalc1
    ...
    kmiter = 1000;
    tic
    Kd = find_Kd_slowiter(0.95,k0,assets,Q,V0,pbeta,pgamma,pdelta,palpha,l,tol,maxiter,ktol,kmiter);
    toc
    % calculate results
...
if recalc2
    ...
    ktol = 0.02;
    kmiter = 1000;
    [Kd2,diff,iter] = find_Kd_slowiter(0.95,k02,assets2,Q,V02,pbeta,pgamma,pdelta,palpha,l,tol,maxiter,ktol,kmiter);
    tic
