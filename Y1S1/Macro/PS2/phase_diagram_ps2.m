...
% annotation('arrow',[3.1 3.13],[1.03 1.03])
% annotation('arrow',[3.1 3.1],[1.03 1.033])
% annotation('arrow',[3.9 3.87],[1.33 1.33])
% annotation('arrow',[3.9 3.9],[1.33 1.3])
% annotation('arrow',[3.4 3.37],[1.35 1.35])
% annotation('arrow',[3.4 3.4],[1.35 1.38])
% annotation('arrow',[3.8 3.8],[1.05 1.02])
% annotation('arrow',[3.8 3.83],[1.05 1.05])
hold off
set(gcf,'Color',[1 1 1])
title('Phase diagram')
ylim([1 1.5])
